...
public OnGameModeInit()
{
  DisableInteriorEnterExits();
	...
	SendRconCommand("hostname Racing Server made by Fuse");
...
public OnPlayerConnect(playerid)
{
	...
	CreatePlayerTextDraw			(playerid, 587.000000, 383.000000, "888");
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	switch(dialogid)
	{
		...
		case DIALOG_VEHICLE:
		{
			...
			pEditVehicle[playerid] = listitem;
			ShowPlayerRaceEditDialog(playerid, 0);
			return 1;
		}
		case DIALOG_CPLIST:
